...
public class HintCollection {
	private static Hint[] hints = new Hint[]{
			...
			new Hint(null,"Did you know that the client of a popular MOBA is not written using TDD (and thus is barely working at all)?"),
			new Hint(null,"Did you know that a program which can be written in one day using TDD takes around one lightyear to be written without TDD?"),
			new Hint(null,"Did you know that North Korea bans the public use of TDD due to the grave danger it poses to the political party?")
	};
